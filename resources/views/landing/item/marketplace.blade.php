        ...
        <div class="v-center">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h6 class="wow fadeInUp" style="padding-top: 150px" data-wow-delay=".5s"><span class="text-uppercase id-color-2">Inspiga MarketPlace</span></h6>
                        <div class="spacer-10"></div>
                        <h1 class="fadeInUp" data-wow-delay=".75s">{{ __('general.slide_text_1')}}</h1>
                    </div>
                    <div class="col-md-12">
                        <div class="row">
...
<section id="section-collections" class="pt30">
    <div class="container">
        ...
        <div class="row wow fadeIn">
            <div class="col-lg-12">
                <h2 class="style-2">{{ __('general.new_items')}}</h2>
            </div>
            ...
            <div class="col-md-12 text-center mt-5">
                <a href="/item" class="btn btn-lg btn-main">{{ __('general.show_more' )}} </a>
            </div>
